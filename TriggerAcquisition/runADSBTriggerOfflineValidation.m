...
positive_case = localRunShadowReplayCase( ...
    ...
    reference_time_utc, ...
    opts.Verbose, ...
    baseline.legacy_capture_settings);
...
default_preview_case = localRunDefaultPreviewCase( ...
    output_root, opts.Verbose, baseline.legacy_capture_settings);
...
function case_result = localRunShadowReplayCase(output_root, replay_baseline, reference_time_utc, verbose, capture_settings)
...
session_result = runADSBTriggeredCaptureSession( ...
    ...
    'Mode', 'shadow', ...
    'CenterFrequency_Hz', capture_settings.CenterFrequency_Hz, ...
    'SampleRate_Hz', capture_settings.SampleRate_Hz, ...
    'LOOffset_Hz', capture_settings.LOOffset_Hz, ...
...
function case_result = localRunDefaultPreviewCase(output_root, verbose, capture_settings)
