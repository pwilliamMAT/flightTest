...
| Newton | TargetPathPower_dBm | -67.56 | local-analysis | Deterministic Longley-Rice rerun over the recovered-ROI baseline; 84 targets on a 0.04 deg grid at 1828.8 m AGL, 0.5 m^2 RCS, 25.0 m receiver site height, and horizontal ERP treated as effective transmitted power for consistency with the retained supporting workflow. | bistatic detectability plausibility |
...
| Hudson | TargetPathPower_dBm | -70.62 | local-analysis | Deterministic Longley-Rice rerun over the recovered-ROI baseline; 84 targets on a 0.04 deg grid at 1828.8 m AGL, 0.5 m^2 RCS, 25.0 m receiver site height, and horizontal ERP treated as effective transmitted power for consistency with the retained supporting workflow. | bistatic detectability plausibility |
...
| RecoveredRoi | LatitudeWindow_deg | 42.308200 to 42.542500 | inferred | Recovered from the saved output figure in FlightTest_Bistatic_RadarAndCommsAnalysis.mlx | bistatic detectability plausibility |
| RecoveredRoi | LongitudeWindow_deg | -71.590800 to -71.004900 | inferred | Recovered from the saved output figure in FlightTest_Bistatic_RadarAndCommsAnalysis.mlx | bistatic detectability plausibility |
| WestCorridor | LatitudeWindow_deg | 42.182143 to 42.416443 | assumed | Additive due-west surveillance corridor defined for the antenna check | due-west surveillance check |
| WestCorridor | LongitudeWindow_deg | -71.849500 to -71.349500 | assumed | Additive due-west surveillance corridor defined for the antenna check | due-west surveillance check |
| WestCorridor | BoresightAzimuth_deg | 270 | assumed | Visual-only due-west receiver boresight marker for the antenna check; not applied as directional receive gain | geometry review |
