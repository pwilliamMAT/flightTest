%% RF Budget Analysis - Passive Radar System
% Signals of Opportunity Aircraft Tracking using HDTV (ATSC) Transmissions
%
% SYSTEM CONFIGURATION:
%   - Transmitter: Channel 27 Univision (548-554 MHz, center: 551 MHz)
...
%   - Filter: Mini-Circuits ZABP-587-S+ (measured specs)
...
% Reference: RFBudgetUpdateProgress.md for detailed analysis
%
%==========================================================================
...
InputFreq = 551e6;              % Channel 27 Univision center frequency (Hz)
...
BP_Filter_Loss_dB = 1.0;        % ZABP-587-S+ insertion loss
...
fprintf('Channel 27 Univision @ 551 MHz\n');
fprintf('========================================\n\n');
...
% Overall title
sgtitle(sprintf('RF Budget Analysis - Channel 27 Univision (551 MHz)\nSystem NF: %.2f dB | Total Gain: %.2f dB | SNR: %.2f dB', ...
...
fprintf('For detailed analysis, see: RFBudgetUpdateProgress.md\n');
fprintf('========================================\n\n');
