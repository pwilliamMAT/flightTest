...
%
% CONFIGURATIONS:
%   A) Hudson Ch 27 (Univision):  551 MHz, ERP TBD
%   B) Newton Ch 35 (CBS):        599 MHz, 922 kW ERP
%
...
% Reference: RFBudgetUpdateProgress.md, RFBudgetUpdateProgress_Newton.md
%
%==========================================================================
...
bpFilterLoss_A = 1.0;           % dB loss (ZABP-587-S+, well-centered)
...
fprintf('\n=== CONFIGURATION B: NEWTON CH 35 (CBS) ===\n\n');
...
erp_B_kW = 922;                 % CBS Tower horizontal ERP (kW)
erp_B_dBW = 10*log10(erp_B_kW * 1000);  % 59.6 dBW

fprintf('⚠️  NOTE: Target power is placeholder - needs bistatic link budget\n');
fprintf('    CBS Tower ERP: %.0f kW (%.1f dBW)\n\n', erp_B_kW, erp_B_dBW);
...
bpFilterLoss_B = 1.5;           % dB loss (ZABP-587-S+, 12 MHz OFF-CENTER ⚠️)
...
fprintf('   ⚠️  Newton Ch 35: CBS Tower is VERY powerful (922 kW ERP)\n');
...
fprintf('   → TODO: Calculate actual bistatic link budget for CBS Tower\n');
...
fprintf('See: RFBudgetUpdateProgress.md and RFBudgetUpdateProgress_Newton.md\n');
fprintf('========================================================================\n\n');
