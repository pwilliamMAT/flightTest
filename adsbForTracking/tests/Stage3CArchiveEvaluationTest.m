classdef Stage3CArchiveEvaluationTest < matlab.unittest.TestCase
    ...
    methods (TestClassSetup)
        function buildStage3CFixture(testCase)
            ...
            variantManifest = readtable( ...
                ...
                "TextType", ...
                "string");
            legacyRows = logical(variantManifest.legacy_pre3day_v1);
            legacySourceFiles = fullfile( ...
                testCase.ProjectRoot, ...
                replace( ...
                    variantManifest.relativeSourceFile(legacyRows), ...
                    "/", ...
                    filesep));
    ...
    methods (Test)
        function testFrozenLegacySelectionAndPiOnlyEmpty(testCase)
