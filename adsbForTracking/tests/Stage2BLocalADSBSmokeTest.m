    ...
    methods (Test)
        ...
        function testRealDataSmokeDatasetBuild(testCase)
            ...
            testCase.verifyEqual( ...
                dataset.buildSummary.canonicalParserPath, ...
                string(which("loadADSBTruth")));
            testCase.verifyEqual( ...
                dataset.buildSummary.parserSHA256, ...
                helperComputeFileSHA256(which("loadADSBTruth")));
            testCase.verifyEqual( ...
                dataset.buildSummary.velocityInterpolationRevision, ...
                "cartesian_velocity_v1");
