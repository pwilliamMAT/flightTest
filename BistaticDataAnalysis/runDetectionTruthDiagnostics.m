...
if opts.PlotRDMOverlays
    if check_summary.has_rdm_cache
        ...
        fprintf('[runDetectionTruthDiagnostics] No cached RDM data in this snapshot; skipping standalone RDM overlay figures.\n');
    end
end
...
check_summary = struct( ...
    ...
    'has_rdm_cache', isfield(truth_diag_input, 'rdm_parts') && ~isempty(truth_diag_input.rdm_parts), ...
