...
if summary.level_pass_fraction >= required_pass_fraction && summary.pilot_pass_fraction < required_pass_fraction
    notes(end + 1) = ['Reference ADC levels are healthy, but PSD-based pilot evidence is not. ' ...
        'That points to insufficient direct-path quality rather than gross clipping or underflow. ' ...
