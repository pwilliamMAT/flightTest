...
<tr><td><span class="evidence-key">TIME-001</span> Time source on the Pi</td><td><span class="status-chip blocked">Blocked</span></td><td>NTP via the desktop, synchronised 2026-09-25 21:07 UTC; GPS/PPS configured, not locked (installed). Pi 14.9 s slow before that, one reading, raw data not kept (measured).</td><td>ADS-B truth written by the Pi before 2026-09-25 21:07 UTC, including the ADS-B artifacts in the historical packages of section 6, carries an unknown clock offset. Whether any package was affected has not been assessed.</td></tr>
</tbody>
</table>
</div>
<div class="callout warn"><strong>Qualification consequence:</strong> the CTRL-001 acceptance criteria in section 9 do not yet include a check of the ADS-B host clock against the capture host clock. Until such a check exists, ADS-B timing evidence for a package should record the Pi’s chrony state at collection time. <span class="evidence-key">TIME-001</span></div>
<p class="source">Primary evidence: <a href="{GH}/As_Built.md">As-Built record</a>, <a href="{GH}/Change_Requests.md">CR-8</a>, <a href="{GH}/Verification_Log.md">Verification Log</a>, <a href="{CT}/deploy/adsb-cue.service">service unit</a>, <a href="{CT}/deploy/pi-cue-config.json">deployed cue configuration</a>. Architecture, message contract, and cue verification are reported in <a href="{SYS}">System Architecture and ADS-B Cue Tasking</a>.</p>
</section>
"""
...
EDITS: list[tuple[str, str]] = [
    ...
    (
        ...
        '<tr><td>Time source (V5)</td><td><span class="status-chip blocked">Blocked</span></td><td><span class="evidence-key">TIME-001</span>: NTP only; GPS/PPS not locked; Pi 14.9 s slow before 2026-09-25 21:07 UTC.</td><td>Pi-timed ADS-B truth before that time carries an unknown offset.</td></tr>',
    ),
    ...
    (
        ...
        "<tr><td>V4</td><td>18 Sep 2026</td><td>Qualification acceptance criteria, channel-role assignment boundary, and audit-stabilization improvements.</td></tr>\n"
        "<tr><td>V5</td><td>26 Sep 2026</td><td>Section 5A: installed ADS-B cue service and as-built time source (CUE-001, TIME-001); links to unpublished CSV companions shown as plain text.</td></tr>",
    ),
    (
        '<article class="card"><h3>Readiness and control</h3><ul class="plain-list">',
        f'<article class="card"><h3>Cueing and time (V5)</h3><ul class="plain-list"><li><a href="{GH}/As_Built.md">As-Built record</a></li><li><a href="{GH}/Verification_Log.md">Verification Log</a></li><li><a href="{SYS}">System Architecture and ADS-B Cue Tasking</a></li></ul></article>\n'
        '<article class="card"><h3>Readiness and control</h3><ul class="plain-list">',
    ),
]
